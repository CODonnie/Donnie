  ...
  return (
    <div className="relative">
      ...
      <div className='w-[100%] h-[45px]'>
        <div className='fixed bottom-24 right-20 sm:right-70 w-20 h-10 rounded-t-full opacity-[70%] bg-gradient-to-b from-accent to-sunAccent shadow-[0_0_60px_20px_var(--sunAccent)]'></div>
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 840 42.3" fill='currentColor' className='fixed bottom-0 h-25 '>
      ...
      <div 
        ...
        className="h-7 w-27 fixed border border-accent bottom-45 right-10 flex items-center justify-end">
        <div className='border border-b-amber-800 absolute w-25 h-7'></div>
        <p className='font-semibold text-1rem'>View More</p>
      </div>
      {/* About element */}
