  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className='hidden md:block xl:hidden'>
        <div className='flex flex-col gap-50 w-8 h-[80%] z-10 py-10 fixed left-7 top-23 [&>p]:hover:rotate-320 [&>p]:hover:font-bold [&>p]:transition-all [&>div>p]:hover:rotate-320 [&>div>p]:hover:font-bold [&>div>p]:transition-all duration-300'>
          <div className='flex flex-col gap-15'>
            <p className='rotate-270 text-[16px] cursor-pointer'><a href="https://www.linkedin.com/in/donnie-ordu"
            target="_blank" rel="noopener" noreferrer>LinkedIn</a></p>
            <p className='rotate-270 text-[16px] cursor-pointer'><a href="https://github.com/CODonnie"
            target="_blank" rel="noopener" noreferrer>Github</a></p>
            <p className='rotate-270 text-[16px] cursor-pointer'><a href="https://behance.net/ordudesigns"
            target="_blank" rel="noopener" noreferrer>Behance</a></p>
          </div>
          <p className='rotate-270 text-[16px] cursor-pointer'><a href="mailto:ordudesigns@gmail.com"
            target="_blank" rel="noopener" noreferrer>Gmail</a></p>
          <p onClick={() => navigate(`/about`)} className='rotate-270 text-[16px] cursor-pointer'>About</p>
        </div>
      </div>
      ...
      <div className="intro fixed bottom-40 left-20">
        <div className='group relative'>
          <div className="flex gap-4 absolute top-20 left-1.5 opacity-0 group-hover:top-15 group-hover:opacity-100 transition-all duration-300">
            <p className='relative'>Chibuike Ordu Donald</p>
          </div>
        ...
        <div className='grid grid-cols-3 w-[300px] border absolute top-[75%]'>
          <p className='text-[16px] border-r border-b pl-1 group flex items-center gap-2 cursor-pointer'>About<div className='hidden rotate-90 bg-accent rounded-full w-2 h-2 group-hover:block group-hover:animate-bounceInfinite'></div></p>
          <p className='text-[16px] col-span-2 pl-1 border-b group flex items-center gap-2'><a href="mailto:ordudesigns@gmail.com"
            target="_blank" rel="noopener" noreferrer>Gmail</a><div className='hidden rotate-90 bg-accent rounded-full w-2 h-2 group-hover:block group-hover:animate-bounceInfinite'></div></p>
          <div className='grid grid-cols-3 col-span-3'>
            <p className='text-[16px] border-r pl-1 group flex items-center gap-2'><a href="https://www.linkedin.com/in/donnie-ordu"
            target="_blank" rel="noopener" noreferrer>LinkedIn</a><div className='hidden rotate-90 bg-accent rounded-full w-2 h-2 group-hover:block group-hover:animate-bounceInfinite'></div></p>
            <p className='text-[16px] border-r pl-1 flex items-center gap-2 group'><a href="https://github.com/CODonnie"
            target="_blank" rel="noopener" noreferrer>Github</a><div className='hidden rotate-90 bg-accent rounded-full w-2 h-2 group-hover:block group-hover:animate-bounceInfinite'></div></p>
            <p className='text-[16px] pl-1 flex items-center gap-2 group'><a href="https://behance.net/ordudesigns"
            target="_blank" rel="noopener" noreferrer>Behance</a><div className='hidden rotate-90 bg-accent rounded-full w-2 h-2 group-hover:block group-hover:animate-bounceInfinite'></div></p>
          </div>
        </div>
      </div>
